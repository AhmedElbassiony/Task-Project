        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">المسئولين </span>
                </div>
            ...
            <div class="header-elements d-none">
                <div class="breadcrumb justify-content-center">
                    <a href="{{ route('admins.create') }}" class="breadcrumb-elements-item font-weight-bold">
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">المسئولين </h5>
        </div>
