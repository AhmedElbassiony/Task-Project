        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">تعديل المسئول</span>
                    <span class="breadcrumb-item active">{{ $admin->first_name . ' ' . $admin->last_name }}</span>
                </div>
            </div>
...
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">تعديل المسئول </h5>
